...
declare module "react-dnd" {
  ...
  declare type ClientOffset = { x: number, y: number };

  declare type ElementOrNode = React.Element<*> | HTMLElement;
  ...
  >(component: C) =>
    & Class<ConnectedComponent<C, InstanceOf<C>, { ...CP } & $Diff<$Diff<P, D>, CP>>>)
    & (<P: SP, S, C: Class<React$Component<P, S>>>(component: C) =>
        & Class<ConnectedComponent<C, InstanceOf<C>, { ...CP }
        & $Diff<P, CP>>>
    )
    & (<P: SP, C: React$ComponentType<P>>(component: C) =>
