...
import {loadYamlFile} from '@gob/cli/lib/read-file'
import populateCourses from '@gob/cli/lib/populate-courses'
import {simplifyCourse, evaluate} from '@gob/examine-student'
...
export function cli() {
    ...
    for (let student of args.students) {
        populateStudent(student).then(evaluateStudentAgainstEachMajor)
    }
}
