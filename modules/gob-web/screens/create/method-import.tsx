...
type Props = {
  readonly initStudent: InitStudentFunc
  // redux
  readonly navigate?: (arg0: string) => unknown
}
...
type State = {
  ...
  parsedStudentText: PartialStudent | null | undefined
}
...
class SISImportScreen extends React.Component<Props, State> {
  ...
  handleRawStudent = (ev: React.SyntheticEvent<HTMLTextAreaElement>) => {
    ev.preventDefault()
