...
type State = {
  message: string
  canGraduate: boolean
  creditsNeeded: number | null | undefined
  creditsTaken: number | null | undefined
  checking: boolean
}
...
class Editor extends React.Component<EditorProps, EditorState> {
  ...
  changeName = (event: React.SyntheticEvent<HTMLInputElement>) => {
    let val = event.currentTarget.value
    this.setState(() => ({ name: val }))
  }

  changeGraduation = (event: React.SyntheticEvent<HTMLInputElement>) => {
    let val = event.currentTarget.value
    this.setState(() => ({ graduation: val }))
  }

  changeMatriculation = (event: React.SyntheticEvent<HTMLInputElement>) => {
    let val = event.currentTarget.value
