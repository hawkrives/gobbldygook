...
export class CourseSearcher extends React.Component<Props, State> {
  ...
  handleSortChange = (ev: React.SyntheticEvent<HTMLSelectElement>) => {
    let value: string = ev.currentTarget.value
    this.setState(() => ({ sortBy: value as any }))
  }

  handleGroupByChange = (ev: React.SyntheticEvent<HTMLSelectElement>) => {
    let value: string = ev.currentTarget.value
    this.setState(() => ({ groupBy: value as any, filterBy: "" }))
  }

  handleFilterByChange = (ev: React.SyntheticEvent<HTMLSelectElement>) => {
    let value: string = ev.currentTarget.value
    this.setState(() => ({ filterBy: value as any }))
  }

  handleLimitToChange = (ev: React.SyntheticEvent<HTMLSelectElement>) => {
    let value: string = ev.currentTarget.value
    this.setState(() => ({ limitTo: value as any }))
  }
  ...
  handleQueryChange = (ev: React.KeyboardEvent<HTMLInputElement>) => {
